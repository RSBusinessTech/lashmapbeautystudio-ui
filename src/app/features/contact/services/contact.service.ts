...
export class ContactService {
  ...
  private url = "https://rsbusinesstech-backend.onrender.com/contact/sendEmailLashMapBeautyStudio";
  //private url = "http://127.0.0.1:8080/contact/sendEmailLashMapBeautyStudio";
